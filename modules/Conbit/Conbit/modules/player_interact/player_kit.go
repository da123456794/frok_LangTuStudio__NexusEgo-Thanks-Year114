...
func (p *PlayerKit) GetInput(breakOnLeave bool) async_wrapper.AsyncResult[*Conbit.GameChat] {
...
func (p *PlayerKit) Query(onResult func([]Conbit.QueryResult), conditions ...string) {
	if p.playerNotAvailable() {
		return
	}
	condstr := strings.Join(conditions, ",")
