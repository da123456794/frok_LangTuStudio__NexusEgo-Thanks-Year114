...
func init() {
	if false {
		func(Conbit.PlayersInfoHolder) {}(&Players{})
	}
}
...
func (p *Players) GetPlayerByUUID(uuid uuid.UUID) (player Conbit.PlayerUQReader, found bool) {
	return p.playersByUUID.Get(uuid)
}

func (p *Players) GetPlayerByUUIDString(uuidStr string) (player Conbit.PlayerUQReader, found bool) {
	uuid := uuid.UUID{}
...
func (p *Players) GetPlayerByUniqueID(uniqueID int64) (player Conbit.PlayerUQReader, found bool) {
...
func (p *Players) GetPlayerByName(username string) (player Conbit.PlayerUQReader, found bool) {
...
func (players *Players) GetAllOnlinePlayers() []Conbit.PlayerUQReader {
	playersOut := make([]Conbit.PlayerUQReader, 0)
	players.playersByUUID.Iter(func(_uuid uuid.UUID, _player *Player) bool {
