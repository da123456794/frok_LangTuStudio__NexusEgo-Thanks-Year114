...
import "github.com/LangTuStudio/Conbit/minecraft/protocol/block_actors"
...
func NewPool() []BlockNBTWithBuffer {
	return []BlockNBTWithBuffer{
		...
		// 命令方块
		{
			...
			Buffer: []byte{1, 0, 0, 0, 0, 0, 0},
		},
		{
			ID:     block_actors.IDNetherReactor,
			Buffer: []byte{1, 0, 0, 1, 30, 248, 0},
		},
		{
			ID:     block_actors.IDNetherReactor,
		...
		{
			ID:     block_actors.IDSkull,
			Buffer: []byte{1, 0, 0, 5, 0, 0, 52, 67, 1, 194, 37},
		},
		{
			ID:     block_actors.IDSkull,
			Buffer: []byte{1, 0, 0, 5, 0, 0, 0, 0, 1, 250, 188, 223, 7},
		},
		// 头颅
		{
		...
		/*
			{
				...
				Buffer: []byte{0x78, 0x6d, 0x69, 0x6e, 0x65, 0x63, 0x72, 0x61, 0x66, 0x74, 0x3a, 0x68, 0x65, 0x61, 0x72, 0x74, 0x5f, 0x70, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x5f, 0x73, 0x68, 0x65, 0x72, 0x64, 0x40, 0x6d, 0x69, 0x6e, 0x65, 0x63, 0x72, 0x61, 0x66, 0x74, 0x3a, 0x68, 0x65, 0x61, 0x72, 0x74, 0x5f, 0x70, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x5f, 0x73, 0x68, 0x65, 0x72, 0x64, 0x40, 0x6d, 0x69, 0x6e, 0x65, 0x63, 0x72, 0x61, 0x66, 0x74, 0x3a, 0x68, 0x65, 0x61, 0x72, 0x74, 0x5f, 0x70, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x5f, 0x73, 0x68, 0x65, 0x72, 0x64, 0x40, 0x6d, 0x69, 0x6e, 0x65, 0x63, 0x72, 0x61, 0x66, 0x74, 0x3a, 0x68, 0x65, 0x61, 0x72, 0x74, 0x5f, 0x70, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x79, 0x5f, 0x73, 0x68, 0x65, 0x72, 0x64, 0x40},
			},
			// 饰纹陶罐
		*/
		{
		...
		{
			ID:     block_actors.IDCauldron,
			Buffer: []byte{1, 0, 0, 0, 1, 1, 1, 179, 199, 254, 4},
		},
		// 炼药锅
		{
		...
		// 讲台
		{
			...
			Buffer: []byte{1, 0, 0, 0, 0, 0, 0, 0, 134, 1, 0, 23, 109, 105, 110, 101, 99, 114, 97, 102, 116, 58, 110, 101, 116, 104, 101, 114, 105, 116, 101, 95, 97, 120, 101, 1, 0, 0, 0, 0, 10, 0, 0, 1, 16, 109, 105, 110, 101, 99, 114, 97, 102, 116, 58, 112, 108, 97, 110, 107, 115, 64, 0, 0, 0, 0, 10, 0, 10, 5, 66, 108, 111, 99, 107, 8, 4, 110, 97, 109, 101, 16, 109, 105, 110, 101, 99, 114, 97, 102, 116, 58, 112, 108, 97, 110, 107, 115, 10, 6, 115, 116, 97, 116, 101, 115, 8, 9, 119, 111, 111, 100, 95, 116, 121, 112, 101, 3, 111, 97, 107, 0, 2, 3, 118, 97, 108, 0, 0, 3, 7, 118, 101, 114, 115, 105, 111, 110, 192, 168, 160, 17, 0, 0},
		},
		// 高炉
		{
		...
		*/
		...
		/*
			{
				ID:     block_actors.IDCrafter,
				Buffer: []byte{}, // 暂缺
			},
			// 合成器
		*/
		{
			ID:     block_actors.IDTrialSpawner,
			Buffer: []byte{1, 2, 97, 63, 0},
		},
		// 试炼刷怪笼
		{
			ID:     block_actors.IDVault,
			Buffer: []byte{1, 0, 0},
		},
		// 宝库
		/*
			{
				ID:     block_actors.IDNeteaseContainer,
				Buffer: []byte{}, // 暂缺
			},
			// Netease container ..
		*/
		{
			ID:     block_actors.IDCraftingTable,
			Buffer: []byte{1, 0, 0, 0},
		},
		// 工作台
	}
