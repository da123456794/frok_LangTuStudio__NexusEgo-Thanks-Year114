...
import "github.com/LangTuStudio/Conbit/minecraft/nbt"
...
// ItemComponentEntry is kept for legacy Netease packet compatibility.
// It is equivalent to the pre-1.21.60 item component table entry.
