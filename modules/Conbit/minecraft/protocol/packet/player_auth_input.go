...
type PlayerAuthInput struct {
	...
	// InteractPitch and InteractYaw are the rotation values intended for interactions.
	...
	// CameraOrientation is the vector that represents the camera's forward direction.
	CameraOrientation mgl32.Vec3
	// RawMoveVector is the value of MoveVector before post-processing.
