...
For more full featured examples that use 3rd party libraries see our **[example-webrtc-applications](https://github.com/LangTuStudio/Conbit)** repo.
...
1. Build and run the example server:
    ``` sh
    git clone https://github.com/LangTuStudio/Conbit webrtc
