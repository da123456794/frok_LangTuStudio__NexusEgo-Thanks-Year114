...
import (
	...
	"github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc/pkg/media"
	"github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc/pkg/media/ivfreader"
	"github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc/pkg/media/oggreader"
)
...
func main() { //nolint:gocognit,cyclop,gocyclo,maintidx
	...
	if haveVideoFile { //nolint:nestif
		...
		go func() {
			...
			// * works around latency issues with Sleep (see https://github.com/LangTuStudio/Conbit)
