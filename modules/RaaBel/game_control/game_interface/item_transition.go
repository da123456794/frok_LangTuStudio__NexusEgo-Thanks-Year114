...
func (h *ItemTransition) Transition(
	...
	srcWindowName resources_control.WindowName,
	dstWindowName resources_control.WindowName,
			...
			if haveCount > requireCount {
				_ = transaction.MoveItem(
					resources_control.SlotLocation{
						WindowName: srcWindowName,
						SlotID:     srcItem.Slot,
					},
					resources_control.SlotLocation{
						WindowName: dstWindowName,
						SlotID:     dstItem.Slot,
					},
					requireCount,
				)
...
func (h *ItemTransition) TransitionBetweenInventory(src []ItemInfoWithSlot, dst []ItemInfoWithSlot) (
	...
	success, err = h.Transition(src, dst, resources_control.WindowNameInventory, resources_control.WindowNameInventory)
	if err != nil {
...
func (h *ItemTransition) TransitionBetweenContainer(src []ItemInfoWithSlot, dst []ItemInfoWithSlot) (
	...
	success, err = h.Transition(src, dst, resources_control.NewWindowName(windowID, 0), resources_control.NewWindowName(windowID, 0))
	if err != nil {
...
func (h *ItemTransition) TransitionToContainer(src []ItemInfoWithSlot, dst []ItemInfoWithSlot) (
	...
	success, err = h.Transition(src, dst, resources_control.WindowNameInventory, resources_control.NewWindowName(windowID, 0))
	if err != nil {
...
func (h *ItemTransition) TransitionToInventory(src []ItemInfoWithSlot, dst []ItemInfoWithSlot) (
	...
	success, err = h.Transition(src, dst, resources_control.NewWindowName(windowID, 0), resources_control.WindowNameInventory)
	if err != nil {
