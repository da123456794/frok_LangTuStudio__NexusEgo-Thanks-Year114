...
var ContainerNeedSlotIDMapping = map[int]bool{
	...
	protocol.ContainerTypeEnchantment:  true,
}
...
var ContainerIDMapping = map[ContainerTypeWithSlot]uint8{
	...
	{ContainerType: protocol.ContainerTypeEnchantment, SlotID: 14}: protocol.ContainerEnchantingInput,    // 23
	{ContainerType: protocol.ContainerTypeEnchantment, SlotID: 15}: protocol.ContainerEnchantingMaterial, // 24,
