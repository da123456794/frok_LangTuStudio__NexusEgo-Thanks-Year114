...
<p align="center">
  ...
  <a href="https://github.com/LangTuStudio/Conbit" alt="Awesome Pion"><img src="https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg"></a>
  <br>
  <img alt="GitHub Workflow Status" src="https://img.shields.io/github/actions/workflow/status/pion/webrtc/test.yaml">
  <a href="https://pkg.go.dev/github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc"><img src="https://pkg.go.dev/badge/github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc.svg" alt="Go Reference"></a>
  ...
  <a href="https://goreportcard.com/report/github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc"><img src="https://goreportcard.com/badge/github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc" alt="Go Report Card"></a>
...
Pion WebRTC v4.0.0 has been released! See the [release notes](https://github.com/LangTuStudio/Conbit) to learn about new features and breaking changes.

If you aren't able to upgrade yet check the [tags](https://github.com/LangTuStudio/Conbit) for the latest `v3` release.
...
**[example-webrtc-applications](https://github.com/LangTuStudio/Conbit)** contains more full featured examples that use 3rd party libraries.

**[awesome-pion](https://github.com/LangTuStudio/Conbit)** contains projects that have used Pion, and serve as real world examples of usage.

**[GoDoc](https://pkg.go.dev/github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc)** is an auto generated API reference. All our Public APIs are commented.

**[FAQ](https://github.com/LangTuStudio/Conbit)** has answers to common questions. If you have a question not covered please ask in [Discord](https://discord.gg/PngbdqpFbt) we are always looking to expand it.
...
One of the maintainers of Pion [Sean-Der](https://github.com/LangTuStudio/Conbit) is available to help. Schedule at [siobud.com/meeting](https://siobud.com/meeting)
...
* [SettingEngine](https://pkg.go.dev/github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc#SettingEngine) for Pion specific extensions
...
* [getUserMedia](https://github.com/LangTuStudio/Conbit) implementation (Requires Cgo)
* Easy integration with x264, libvpx, GStreamer and ffmpeg.
* [Simulcast](https://github.com/LangTuStudio/Conbit)
* [SVC](https://github.com/LangTuStudio/Conbit)
* [NACK](https://github.com/LangTuStudio/Conbit)
* [Sender/Receiver Reports](https://github.com/LangTuStudio/Conbit)
* [Transport Wide Congestion Control Feedback](https://github.com/LangTuStudio/Conbit)
* [Bandwidth Estimation](https://github.com/LangTuStudio/Conbit)
...
* Wide platform support
  ...
  * iOS, Android
  * [WASM](https://github.com/LangTuStudio/Conbit) see [examples](examples/README.md#webassembly)
...
* Tools to measure performance [provided](https://github.com/LangTuStudio/Conbit)

### Roadmap
The library is in active development, please refer to the [roadmap](https://github.com/LangTuStudio/Conbit) to track our major milestones.
We also maintain a list of [Big Ideas](https://github.com/LangTuStudio/Conbit) these are things we want to build but don't have a clear plan or the resources yet.
...
### Contributing
Check out the [contributing wiki](https://github.com/LangTuStudio/Conbit) to join the group of amazing people making this project possible
