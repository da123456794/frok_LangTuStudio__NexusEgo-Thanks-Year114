...
```
go install github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc/examples/rtp-to-webrtc@latest
```
...
It can be used to re-order and delay for lossy streams. You can see its usage in this example in [daf27b](https://github.com/LangTuStudio/Conbit).

Currently it isn't working with H264, but is useful for VP8 and Opus. See [#1652](https://github.com/LangTuStudio/Conbit) for the status of fixing for H264.
