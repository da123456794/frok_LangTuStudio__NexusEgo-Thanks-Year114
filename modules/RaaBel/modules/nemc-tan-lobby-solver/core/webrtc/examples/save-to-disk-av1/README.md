...
If you wish to save VP8 and Opus instead of AV1 see [save-to-disk](https://github.com/LangTuStudio/Conbit)
...
```
go install github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc/examples/save-to-disk-av1@latest
```
