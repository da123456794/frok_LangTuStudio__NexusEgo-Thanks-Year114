...
If you wish to save VP9 instead of VP8 you can just replace all occurences of VP8 with VP9 in [main.go](https://github.com/LangTuStudio/Conbit).

If you wish to save VP8/Opus inside the same file see [save-to-webm](https://github.com/LangTuStudio/Conbit)

If you wish to save AV1 instead see [save-to-disk-av1](https://github.com/LangTuStudio/Conbit)

You can then send this video back to your browser using [play-from-disk](https://github.com/LangTuStudio/Conbit)

## Instructions
### Download save-to-disk
```
go install github.com/Happy2018new/nemc-tan-lobby-solver/core/webrtc/examples/save-to-disk@latest
```
