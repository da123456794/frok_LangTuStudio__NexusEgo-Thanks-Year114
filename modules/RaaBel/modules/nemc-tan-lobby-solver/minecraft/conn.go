...
func newConn(
	...
	conn := &Conn{
		enc:          packet.NewEncoder(netConn, readAndWriteHeader),
		dec:          packet.NewDecoder(netConn, readAndWriteHeader),
		salt:         make([]byte, 16),
...
func (conn *Conn) handleResourcePacksInfo(pk *packet.ResourcePacksInfo) error {
	// Hacking: We don't want to download anything
	pk = new(packet.ResourcePacksInfo)
...
func (conn *Conn) handleResourcePackStack(pk *packet.ResourcePackStack) error {
	// Hacking: We don't want to download anything
	pk = new(packet.ResourcePackStack)
