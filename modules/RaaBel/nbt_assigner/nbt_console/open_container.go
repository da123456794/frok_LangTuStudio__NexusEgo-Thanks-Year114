...
func (c *Console) OpenContainerByIndex(index int) (success bool, err error) {
	...
	switch b := (*block).(type) {
	case block_helper.AnvilBlockHelper, block_helper.LoomBlockHelper, block_helper.CraftingTableBlockHelper, block_helper.CrafterBlockHelper:
