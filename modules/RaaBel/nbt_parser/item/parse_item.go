...
func ParseItemNormal(
	...
	case mapping.SupportNBTItemTypeFirework:
		item = &FireworkRocket{DefaultItem: defaultItem}
	case mapping.SupportNBTItemTypeBundle:
		item = &Bundle{DefaultItem: defaultItem}
	default:
